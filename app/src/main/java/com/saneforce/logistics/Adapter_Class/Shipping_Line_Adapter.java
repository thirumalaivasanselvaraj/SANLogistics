...
public class Shipping_Line_Adapter extends RecyclerView.Adapter<Shipping_Line_Adapter.MyViewHolder> {
    ...
    public Shipping_Line_Adapter(List<String> fuel, Context context, String frag_name_, String selected_value) {
    ...
    @Override
    public Shipping_Line_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemlayout = LayoutInflater.from(parent.getContext()).inflate(R.layout.tickmark_listview, null);
        Shipping_Line_Adapter.MyViewHolder viewHolder = new Shipping_Line_Adapter.MyViewHolder(itemlayout, mcontext);
    ...
    @Override
    public void onBindViewHolder(final Shipping_Line_Adapter.MyViewHolder holder, final int position) {
        ...
        holder.linear_selecet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (frag_name != null && frag_name.equals("Shiping_Line")) {
                    clicl_listner_fuel.onClick(v, position, "Shiping_Line", "Shiping_Line", meker_list);
