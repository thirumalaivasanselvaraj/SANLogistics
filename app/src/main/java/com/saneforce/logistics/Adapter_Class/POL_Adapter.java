...
public class POL_Adapter extends RecyclerView.Adapter<POL_Adapter.MyViewHolder> {
    ...
    public POL_Adapter(List<String> fuel, Context context, String frag_name_, String selected_value) {
    ...
    @Override
    public POL_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemlayout = LayoutInflater.from(parent.getContext()).inflate(R.layout.tickmark_listview, null);
        POL_Adapter.MyViewHolder viewHolder = new POL_Adapter.MyViewHolder(itemlayout, mcontext);
    ...
    @Override
    public void onBindViewHolder(final POL_Adapter.MyViewHolder holder, final int position) {
        ...
        holder.linear_selecet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (frag_name != null && frag_name.equals("POL")) {
                    clicl_listner_fuel.onClick(v, position, "POL", "POL", meker_list);
