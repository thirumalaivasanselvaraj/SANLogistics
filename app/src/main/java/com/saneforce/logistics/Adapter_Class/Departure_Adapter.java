...
public class Departure_Adapter extends RecyclerView.Adapter<Departure_Adapter.MyViewHolder> {
    ...
    public Departure_Adapter(List<String> fuel, Context context, String frag_name_, String selected_value) {
    ...
    @Override
    public Departure_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemlayout = LayoutInflater.from(parent.getContext()).inflate(R.layout.tickmark_listview, null);
        Departure_Adapter.MyViewHolder viewHolder = new Departure_Adapter.MyViewHolder(itemlayout, mcontext);
    ...
    @Override
    public void onBindViewHolder(final Departure_Adapter.MyViewHolder holder, final int position) {
        ...
        holder.linear_selecet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (frag_name != null && frag_name.equals("Departure")) {
                    clicl_listner_fuel.onClick(v, position, "Departure", "Departure", meker_list);
